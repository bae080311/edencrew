...
class AppDimens extends ThemeExtension<AppDimens> {
  ...
  AppDimens copyWith({
    ...
    return AppDimens(
      ...
      appBarPaddingVertical:
          appBarPaddingVertical ?? this.appBarPaddingVertical,
      ...
      tableRowPaddingVertical:
          tableRowPaddingVertical ?? this.tableRowPaddingVertical,
    );
  }
  ...
  AppDimens lerp(covariant AppDimens? other, double t) {
    ...
    return AppDimens(
      ...
      fieldPaddingVertical: lerpDouble(
        fieldPaddingVertical,
        other.fieldPaddingVertical,
        t,
      )!,
      toastPaddingVertical: lerpDouble(
        toastPaddingVertical,
        other.toastPaddingVertical,
        t,
      )!,
      gapToastBottom: lerpDouble(gapToastBottom, other.gapToastBottom, t)!,
      radiusSheet: lerpDouble(radiusSheet, other.radiusSheet, t)!,
      sheetTitleHeight: lerpDouble(
        sheetTitleHeight,
        other.sheetTitleHeight,
        t,
      )!,
      appBarPaddingVertical: lerpDouble(
        appBarPaddingVertical,
        other.appBarPaddingVertical,
        t,
      )!,
      ...
      cardPaddingVertical: lerpDouble(
        cardPaddingVertical,
        other.cardPaddingVertical,
        t,
      )!,
      gapCardLabel: lerpDouble(gapCardLabel, other.gapCardLabel, t)!,
      tableRowPaddingVertical: lerpDouble(
        tableRowPaddingVertical,
        other.tableRowPaddingVertical,
        t,
      )!,
    );
  }
